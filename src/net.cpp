...
static const char *strMainNetDNSSeed[][2] = {
    {"solarcoin.zapto.org", "solarcoin.zapto.org"},
    {"seed1.solarcoin.org", "seed1.solarcoin.org"},
    {"seed2.solarcoin.org", "seed2.solarcoin.org"},
    {"seed1.solarcoin.com", "seed1.solarcoin.com"},
    {"seed2.solarcoin.com", "seed2.solarcoin.com"},
    // Add more DNS seeds to the list of necessary at a later date
    // {"website.info", "dnsseed.website.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testseed.solarcoin.org", "testseed.solarcoin.org"},
    // Add more DNS seeds to the list of necessary at a later date    
	// {"solarcoin.info", "testnet-seed.solarcoin.org"},
    {NULL, NULL}
};
