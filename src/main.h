...
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 SLR mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = (long) 1000000000000 * (long) COIN; // SolarCoin: maximum of 98.1 billion coins
