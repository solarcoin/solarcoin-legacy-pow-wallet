    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a SolarCoin address (e.g. 8ShM3UpgFZnXzJ5zux1AWQvAE36rFJKMs7)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a SolarCoin address (e.g. 8ShM3UpgFZnXzJ5zux1AWQvAE36rFJKMs7)"));
